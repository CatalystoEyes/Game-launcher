    ...
    <div className="flex">
      <form onSubmit={handleSubmit}>
        <label>
          ...
          <input className="input input-bordered max-w-xs mx-1" type="text" placeholder="Description" value={game.description} onChange={e => setGame({ ...game, description: e.target.value })} />
