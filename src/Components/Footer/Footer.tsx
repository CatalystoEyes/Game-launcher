...
const Footer = () => {
    return (
        <div className='grid justify-items-end' data-theme="sunset">
            <footer className="footer p-4 items-center bg-neutral text-neutral-content">
                ...
                <nav className="grid-flow-col gap-4 "></nav>
                <CreateGame />
            </footer>
        </div>
    )
