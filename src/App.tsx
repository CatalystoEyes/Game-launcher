        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <div className="form-control">
              <input type="search" className="input input-bordered w-full bg-base-100" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder="Enter search game" />
            </div>
          </div>
